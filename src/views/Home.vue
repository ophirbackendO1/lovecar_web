<template>
    ...
    <div class="container">
      <div class="mt-5 row d-flex justify-center items-center">
        <div class="col-md-6 d-flex justify-center">
          <p class="font-semibold mt-4" style="font-size:18px;"> ဘာကြောင့် Love Carကိုအသုံးပြုသင့်တာလဲ</p>
        </div>
  ...
  <!-- feeback section -->
  <div class="container-fluid bg-[#f5e0e0] bg-opacity-30 py-4">
    <div class="container">
          ...
          <div class="carousel-item active">
            <div class="row">
              <div class="col-12 col-lg-4">
                <img src="https://cdn.pixabay.com/photo/2018/10/02/20/37/group-3719888_640.png" class="d-block w-100"
                  alt="...">
              </div>
  ...
  <div class="container-fluid d-flex justify-center items-center bg-[#f5e0e0] bg-opacity-30 py-4">
    <div class="row d-flex justify-center items-center mt-4">
      <div class="col-md-7 leading-10">
        ...
        <p class="text-center font-semibold">ကားအသုံးပြုသူများအတွက် အကျိုးရှိစေမည့် Love Car App ကို အခုပဲ Download
          ပြုလုပ်လိုက်ပါ</p>
...
const cards = ref([
  ...
  },
  {
    ...
    description: 'ယာဥ်မောင်းလိုင်စင် ဖြေမယ့်သူတွေအနေနဲ့လည်း အစမ်းလေ့ကျင့်ခန်းမေးခွန်းတွေ ဖြေဆိုနိုင်မယ်။',
