<template>
    <div class="body text-justify">
        ...
        <p>When you register for a LoveCar account or correspond with us, we may ask you to provide certain information
            such as your username, profile picture, first and last name, phone number, city, state, and email address.
            We also collect any messages or feedback you send us through the Service, as well as information about your
            mobile device (such as IMEI, brand, and model).</p>
        <p>We use the IMEI number and model to help limit the creation of multiple accounts from a single device. This
        ...
        <p>We also use the information you provide, including your contact details and device data, to operate,
            maintain, and improve the features and functionality of the Service, to communicate with you, and to address
        ...
        <p>We take the privacy and security of your personal information very seriously. All data is stored and
            transmitted using industry-standard encryption protocols to protect against unauthorized access or misuse.
        </p>

        <h2>2. Information we receive from third-party application</h2>
        <p>In addition to the information you provide directly to us when creating a LoveCar account, we also collect
            certain data from third-party applications and services that you choose to connect to your LoveCar account.
        </p>
        <p>One such integration is the ability to create a LoveCar account using your existing Google account. When you
            select this option, we will collect your Google User ID (UID), your Gmail email address, and the username
            associated with your Google account. This information allows us to quickly and securely set up your LoveCar
        ...
        <p>We use this third-party account information solely for the purpose of establishing and maintaining your
            LoveCar account. We do not share or use this data for any other purpose without your explicit consent.</p>
        <p>All information collected from third-party applications, including Google, is stored and protected with the
        ...
        <p>If you choose to disconnect your third-party account integration at any time, we will promptly remove all
            associated data from our systems, in accordance with our data retention and deletion policies outlined in
            the "Account Deleting" section. Please let us know if you have any questions or concerns about our use of
            information from third-party applications. We're committed to being transparent about our data practices and
            ensuring the privacy and security of your personal information.</p>

        <h2>3. Location Access</h2>
        <p>Our app requires access to your device's location in order to provide certain features and functionalities.
        ...
        <p>We collect your location data using the device's built-in GPS, Wi-Fi, or cellular network positioning
            ...
            third parties without your explicit consent. You can manage your location permissions at any time by going
            to your device's settings menu and adjusting the location access settings for our app. If you choose to
            disable location access, some features of our app may become unavailable or may not function as intended. We
            take the privacy and security of your location data very seriously. All location information is stored and
            transmitted using industry-standard encryption and security protocols to protect against unauthorized access
        ...
        <p>Our Service allows you to create and manage information about your car, such as fuel costs, maintenance
            expenses, income, and other relevant data. We collect and store this information in our database to provide
        ...
        <p>If you choose not to provide your personal information or car-related data, you may not be able to access or
        ...
        <p>LoveCar cares about the security of your information, and uses appropriate safeguards to preserve the
            ...
            granting you access to your account. You are responsible for maintaining the secrecy of your unique password
            and account information, and for controlling access to your email communications from LoveCar, at all times.
        ...
        <p>Following termination or deactivation of your user account, LoveCar will retain your profile information and
        ...
        <p>Our app offers an account deletion feature, which allows you to request the removal of your LoveCar account
            and all associated data. When you submit a deletion request, we will retain your account information for a
            certain period of time (e.g., 14 days) before permanently deleting it. During this time, you can choose to
            discard your deletion request if you change your mind. Once the retention period has elapsed, your account
            and data will be deleted, and this action cannot be undone.</p>
        <p>We offer this feature to respect your right to privacy and give you control over your personal information.
            If you decide to delete your account, we will permanently remove all of your data, including any car-related
        ...
        <p>Please note that if you have an outstanding balance or unresolved issues with our service, we may need to
            ...
            respect your privacy and delete your data as soon as possible, while also ensuring we can properly address
            any outstanding obligations.</p>
        <p>If you have any questions or concerns about the account deletion process, please don't hesitate to contact
        ...
        <p>As part of our service, we may send notifications and other communications to our users to provide important
        ...
        <p>The content and frequency of these notifications will vary, but we aim to strike a balance between providing
            valuable information and avoiding excessive or disruptive messages.</p>
        <p>We will never sell or share your contact information (email, phone number, etc.) with third-party advertisers
            or marketing companies. All notifications and communications from LoveCar will be directly related to the
            services and features we provide.</p>
        <p>If you have any questions or concerns about the notifications you receive, please don't hesitate to reach out
